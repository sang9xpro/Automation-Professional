...
export const AccountsDeleteDialog = (props: IAccountsDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="automationProfessionalApp.accounts.delete.question">
        <Translate contentKey="automationProfessionalApp.accounts.delete.question" interpolate={{ id: accountsEntity.id }}>
