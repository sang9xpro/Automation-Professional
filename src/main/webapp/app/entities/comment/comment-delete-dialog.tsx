...
export const CommentDeleteDialog = (props: ICommentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="automationProfessionalApp.comment.delete.question">
        <Translate contentKey="automationProfessionalApp.comment.delete.question" interpolate={{ id: commentEntity.id }}>
