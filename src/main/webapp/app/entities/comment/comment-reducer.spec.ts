...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.FETCH_COMMENT_LIST), REQUEST(ACTION_TYPES.SEARCH_COMMENTS), REQUEST(ACTION_TYPES.FETCH_COMMENT)],
        {},
        state => {
          expect(state).toMatchObject({
            errorMessage: null,
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_COMMENT),
          REQUEST(ACTION_TYPES.UPDATE_COMMENT),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_COMMENT),
          REQUEST(ACTION_TYPES.DELETE_COMMENT),
        ],
        {},
        state => {
          expect(state).toMatchObject({
  ...
  describe('Successes', () => {
    ...
    it('should search all entities', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.SEARCH_COMMENTS),
          payload,
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.SEARCH_COMMENTS actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.SEARCH_COMMENTS),
        },
        {
          type: SUCCESS(ACTION_TYPES.SEARCH_COMMENTS),
          payload: resolvedObject,
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_COMMENT actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_COMMENT),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_COMMENT),
          payload: resolvedObject,
        },
      ];
