    ...
    <Row>
      <Col md="8">
        <h2 data-cy="commentDetailsHeading">
          <Translate contentKey="automationProfessionalApp.comment.detail.title">Comment</Translate>
        </h2>
