...
export interface IMostOfContFieldsDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export const MostOfContFieldsDetail = (props: IMostOfContFieldsDetailProps) => {
  useEffect(() => {
    ...
    <Row>
      <Col md="8">
        <h2 data-cy="mostOfContFieldsDetailsHeading">
          <Translate contentKey="automationProfessionalApp.mostOfContFields.detail.title">MostOfContFields</Translate>
        </h2>
...
export default connect(mapStateToProps, mapDispatchToProps)(MostOfContFieldsDetail);
