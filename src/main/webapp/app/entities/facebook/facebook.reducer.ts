...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_FACEBOOK: 'facebook/PARTIAL_UPDATE_FACEBOOK',
...
export default (state: FacebookState = initialState, action): FacebookState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_FACEBOOK):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_FACEBOOK):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_FACEBOOK):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IFacebook> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_FACEBOOK,
