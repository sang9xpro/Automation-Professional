...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="automationProfessionalApp.country.delete.question">
        <Translate contentKey="automationProfessionalApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
