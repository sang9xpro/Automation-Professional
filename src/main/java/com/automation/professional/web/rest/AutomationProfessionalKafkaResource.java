...
@RestController
@RequestMapping("/api/automation-professional-kafka")
public class AutomationProfessionalKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AutomationProfessionalKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public AutomationProfessionalKafkaResource(KafkaProperties kafkaProperties) {
