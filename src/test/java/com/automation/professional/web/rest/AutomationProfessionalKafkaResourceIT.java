...
import com.automation.professional.config.KafkaProperties;
...
class AutomationProfessionalKafkaResourceIT {
    ...
    void setup() {
        ...
        AutomationProfessionalKafkaResource kafkaResource = new AutomationProfessionalKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/automation-professional-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/automation-professional-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
